...
export class FileTickedWarehouseService {
    /**
     ...
     */
    async downloadTicket(data: any, tipoDocument: string) {
            ...
            content: [
                {
                    ...
                    table: {
                        ...
                        body: [
                            ...
                            [
                                { text: "EMPRESA SAC - RUC: 20123456789", style: ["title"], colSpan: 3, alignment: "center" },
                                {},
                                {},
                            ],
                            [
                ...
                { text: "**********************************************************", style: ["small", "horiAlignCenter"] },
                { text: "SON: " + data.vent_venta_precio_cobrado_letras + ' SOLES', style: ["small", "horiAlignCenter"] },
                '\n',
