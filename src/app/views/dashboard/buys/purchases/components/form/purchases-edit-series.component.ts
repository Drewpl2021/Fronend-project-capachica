...
@Component({
    selector: 'app-purchases-edit-series',
    standalone: true,
...
export class PurchasesSeriesComponent implements OnInit {
    purchasesForm: FormGroup;
    quantity: number;
    constructor(
        private fb: FormBuilder,
        private _matDialog: MatDialogRef<PurchasesSeriesComponent>,
        @Inject(MAT_DIALOG_DATA) public data: any) {
        this.quantity = data.quantity || 0;
        this.purchasesForm = this.fb.group({
            initialSeries: ['', Validators.required],
