...
@Component({
    selector: 'app-warrinties-filter',
    standalone: true,
            ...
            <div class="actions-container">
                <form class="form-container" [formGroup]="unitMeasurementFilterForm">
                    <mat-form-field class="mat-field-custom fuse-mat-dense fuse-mat-rounded" [subscriptSizing]="'dynamic'">
                        ...
                        <input matInput [formControlName]="'seriesCode'" [autocomplete]="'off'" [placeholder]="'Buscar Serie'"/>
                    </mat-form-field>
                </form>
            </div>
        </div>
...
export class WarrantiesFilterComponent implements OnInit {
