...
@Component({
    selector: 'app-accounting-dynamic-filter',
    standalone: true,
    imports: [
        FormsModule,
        MatIconModule,
...
export class AccountingDynamicFilterComponent implements OnInit {
