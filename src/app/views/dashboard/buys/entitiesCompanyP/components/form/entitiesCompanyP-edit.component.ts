...
import {EntitiesCompanyP, DocumentTypes, EntityTypes, Services} from "../../models/entitiesCompanyP";
...
export class EntitiesCompanyPEditComponent implements OnInit {
    @Input() title: string = '';
    @Input() entitys = new EntitiesCompanyP();
    ...
    constructor(
        ...
        private _matDialog: MatDialogRef<EntitiesCompanyPEditComponent>,
