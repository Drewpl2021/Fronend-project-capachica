    ...
    template: `
        <div class="flex flex-col max-w-240 md:min-w-160 max-h-screen -m-6">
            <div class="flex flex-0 items-center justify-between h-16 pr-3 sm:pr-5 pl-6 sm:pl-8 bg-primary text-on-primary">
                <div class="text-lg font-medium">Nueva Cuenta Contable</div>
...
export class AccountingAccountClassNewComponent implements OnInit {
    @Input() title: string = '';
    abcForms: any;
    ...
    constructor(
        private _matDialog: MatDialogRef<AccountingAccountClassNewComponent>
    ) {}
    ngOnInit() {
