        ...
        <div class="table-container">
            <table class="custom-table">
                ...
                <tr class="bg-primary-600 text-white">
                    ...
                    <th class="w-1/9 table-header text-center border-r">Costo</th>
                ...
                <tbody class="bg-white">
                   ...
                   bg-{{category.status === 1 ? 'green' : 'red'}}-500/20
                   text-{{category.status === 1 ? 'green' : 'red'}}-600
                   py-1 px-2 text-xs rounded-md"
                                        style="opacity: 1">
                                        <span>{{ category.status === 1 ? 'ACTIVO' : 'INACTIVO' }}</span>
                                    </div>
                                </div>
                            </td>
