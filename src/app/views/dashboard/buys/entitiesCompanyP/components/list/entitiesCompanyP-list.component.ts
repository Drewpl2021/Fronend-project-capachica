...
import { EntitiesCompanyP} from '../../models/entitiesCompanyP';
...
@Component({
    selector: 'app-entities-provider-list',
    standalone: true,
    imports: [
        FormsModule,
        CommonModule,
                            ...
                            <td class="w-1/9 p-2 text-center border-b text-sm">
                                <div class="flex justify-center space-x-3">
                                    <mat-icon
                                        ...
                                        (click)="goEdit(entity.entitys?.id)"
                                    ...
                                    <mat-icon
                                        ...
                                        matTooltipPosition="above"
                                        (click)="goDelete(entity.entitys?.id)"
...
export class EntitiesCompanyPListComponent implements OnInit {
    abcForms: any;
    @Input() entities: EntitiesCompanyP[] = [];
