...
import {DocumentTypes, EntityTypes, Services} from "../../models/entitiesCompanyC";
...
export class EntitiesCompanyCNewComponent implements OnInit {
    @Input() title: string = '';
    ...
    constructor(
        ...
        private _matDialog: MatDialogRef<EntitiesCompanyCNewComponent>,
