...
import {Entities, DocumentTypes, EntityTypes, Services} from "../../models/entities";
...
export class EntitiesEditComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialog: MatDialogRef<EntitiesEditComponent>,
