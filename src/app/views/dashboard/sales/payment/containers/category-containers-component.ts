...
import { PaginatedResponse, Payment, PaymentFilter } from '../models/category';
import { PaymentService } from 'app/providers/services/sales/payment.service';
import {Payments} from "../../../payments/payments/models/payments";
...
export class CategoryContainersComponent implements OnInit {
    ...
    public eventEdit(id: string): void {
        this._categoryService.getById$(id).subscribe((response) => {
            ...
            const dialogComp = categoryForm.componentInstance as CategoryEditComponent;
            (categoryForm.componentInstance as CategoryEditComponent).title = 'Editar Pago';
            (categoryForm.componentInstance as CategoryEditComponent).parentModule = response;
