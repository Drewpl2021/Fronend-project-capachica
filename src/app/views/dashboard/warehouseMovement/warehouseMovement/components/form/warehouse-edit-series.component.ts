...
@Component({
    selector: 'app-warehouse-edit-series',
    standalone: true,
...
export class WarehouseEditSeriesComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialog: MatDialogRef<WarehouseEditSeriesComponent>,
