...
@Component({
    selector: 'app-accounting-account-class-filter',
    standalone: true,
    ...
    template: `
        <div class="header-container">
            <div class="header-title  bg-primary-600">
                ...
                <span>Clase de Cuentas Contables</span>
            </div>
            <div class="actions-container">
                <form class="form-container" [formGroup]="unitMeasurementFilterForm">
                    <mat-form-field class="mat-field-custom fuse-mat-dense fuse-mat-rounded" [subscriptSizing]="'dynamic'">
                        ...
                        <input matInput [formControlName]="'concatenatedFields'" [autocomplete]="'off'" [placeholder]="'Buscar Cuenta Contables'"/>
                    </mat-form-field>
                </form>
...
export class AccountingAccountClassFilterComponent implements OnInit {
