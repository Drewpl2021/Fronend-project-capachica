...
import {PaginatedResponse, ParentModule, ParentModuleFilter} from '../models/parent-module';
...
export class ParentModuleContainersComponent implements OnInit {
    ...
    public parentModuleFilter: ParentModuleFilter;
    public parentModule = new ParentModule();
    ...
    public eventFilter(parentModuleFilter: ParentModuleFilter): void {
    ...
    private edit(parentModule: ParentModule) {
