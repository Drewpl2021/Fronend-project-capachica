    ...
    template: `
        <div class="flex flex-col max-w-240 md:min-w-160 max-h-screen -m-6">
            ...
            <div
                ...
                <div class="text-lg font-medium">Nuevo Unidad de medida</div>
...
export class UnitMeasurementNewComponent implements OnInit {
    @Input() title: string = '';
    ...
    constructor(
        private _matDialog: MatDialogRef<UnitMeasurementNewComponent>
    ) {
    }
