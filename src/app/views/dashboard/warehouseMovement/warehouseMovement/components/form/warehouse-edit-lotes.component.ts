...
@Component({
    selector: 'app-warehouse-edit-lotes',
    standalone: true,
...
export class WarehouseEditLotesComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialog: MatDialogRef<WarehouseEditLotesComponent>,
