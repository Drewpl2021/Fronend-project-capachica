...
@Component({
    ...
    standalone: true,
    imports: [FormsModule, MatIconModule, MatButtonModule, ReactiveFormsModule, MatSlideToggleModule, MatFormFieldModule, MatInputModule, MatDatepickerModule, MatNativeDateModule, NgForOf, NgIf,],
    template: `
                ...
                <form class="form-container" [formGroup]="unitMeasurementFilterForm" (ngSubmit)="onSubmit()" style="display: flex; flex-wrap: wrap; gap: 8px; width: 100%;">
                    <div class="col-span-6 relative" style="flex: 2; min-width: 300px;">
                        <mat-form-field class="mat-field-custom fuse-mat-dense fuse-mat-rounded" [subscriptSizing]="'dynamic'" style="width: 100%;">
                            ...
                            <input matInput formControlName="proveedor" autocomplete="off" placeholder="Buscar Proveedor" (input)="searchProvider(unitMeasurementFilterForm.get('proveedor')?.value)"/>
                        </mat-form-field>
...
export class PurchasesFilterComponent implements OnInit {
