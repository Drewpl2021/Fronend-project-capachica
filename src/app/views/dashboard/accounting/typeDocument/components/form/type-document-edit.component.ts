...
@Component({
    selector: 'app-type-document-new',
    standalone: true,
    imports: [
        FormsModule,
        MatIconModule,
            ...
            <form class="flex flex-col flex-auto p-6 sm:p-8 overflow-y-auto" [formGroup]="documentForm">
                ...
                <div class="flex flex-col sm:flex-row sm:items-center justify-between mt-4 sm:mt-6">
                    <div class="flex space-x-2 items-center mt-4 sm:mt-0">
                        ...
                        <button class="ml-auto sm:ml-0" color="primary" [disabled]="documentForm.invalid"
...
export class TypeDocumentEditComponent implements OnInit {
    @Input() title: string = '';
    @Input() unitMeasurement = new TypeDocument();
    abcForms: any;
    ...
    constructor(
        private _matDialog: MatDialogRef<TypeDocumentEditComponent>
    ) {
    }

    ngOnInit() {
        this.abcForms = abcForms;
        this.documentForm.patchValue(this.unitMeasurement);

    }

    public saveForm(): void {
        if (this.documentForm.valid) {
            this._matDialog.close(this.documentForm.value);
        }
    }
