...
import {OperationType} from "../../../../payments/payments/models/payments";
    ...
    template: `
        <div class="flex flex-col max-w-240 md:min-w-160 max-h-screen -m-6">
            <div
                ...
                <div class="text-lg font-medium">Nuevo Precio</div>
...
export class PricesNewComponent implements OnInit {
    ...
    constructor(
        private _matDialog: MatDialogRef<PricesNewComponent>,
