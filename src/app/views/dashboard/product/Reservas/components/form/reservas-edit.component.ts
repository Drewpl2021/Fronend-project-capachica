...
export class ReservasEditComponent implements OnInit {
    @Input() title: string = '';
    @Input() unitMeasurement = new Reservas();
    abcForms: any;
    ...
    constructor(
        private _matDialog: MatDialogRef<ReservasEditComponent>
    ) {
    }

    ngOnInit() {
        this.abcForms = abcForms;
        this.categoryForm.patchValue(this.unitMeasurement);
