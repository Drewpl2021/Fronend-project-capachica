...
@Component({
    selector: 'app-type-affectation-filter',
    standalone: true,
    imports: [
        FormsModule,
        MatIconModule,
        ...
        <div class="header-container">
            ...
            <div class="actions-container">
                ...
                <button class="action-button" mat-flat-button [color]="'primary'" (click)="goNew()">
                    ...
                    <span>Nuevo Tipo de Afectación</span>
                </button>
            </div>
        </div>
...
export class TypeAffectationFilterComponent implements OnInit {
