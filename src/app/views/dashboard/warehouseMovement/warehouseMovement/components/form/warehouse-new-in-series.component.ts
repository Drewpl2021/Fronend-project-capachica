                    ...
                    <table class="min-w-full divide-y divide-gray-200 border">
                        ...
                        <tr *ngFor="let serie of series.controls; let i = index" [formGroupName]="i">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap flex items-center">
                                ...
                                (input)="onSerieChange(i); checkFormValidity()"/>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <select (change)="onSelectSeries($event.target.value, i)" class="w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                                    ...
                                    <!-- ✅ Opción cuando no hay datos disponibles -->
                                    <option *ngIf="!seriesOptions[i] || seriesOptions[i].length === 0" disabled>No hay opciones disponibles</option>

                                    <!-- ✅ Filtrar las opciones para que no aparezcan las ya seleccionadas -->
...
export class WarehouseNewInSeriesComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialog: MatDialogRef<WarehouseNewInSeriesComponent>,
        ...
        this.inicializarSeries(data.series || []);
    }
    ...
    private CargarDatos(seriesCodePattern: string, index: number) {
        const params = {
    ...
    private inicializarSeries(series: any[]): void {
